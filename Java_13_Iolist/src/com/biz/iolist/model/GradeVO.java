 ...
 * 3. super / field 생성자 정의
 * 4. toString() method 정의
...
public class GradeVO {
	...
	/*
	 * Object class에서 정의된 toString() method는
	 * 객체가 생성된 주소를 보여주는 method이다.
	 * 실제 자바에서 객체가 생성된(저장된) 주소는 별 의미가 없다.
	 * 
	 * 그래서 vo class를 만들때
	 * 이클립스의 자동코드작성 기능을 이용해서
	 * toSting() method를 재정의한다.
	 * 
	 * 이렇게 재정의를 하면 
	 * vo 객체의 멤버변수에 어떤 값을 setting한후
	 * 값들이 정상적으로 저장되어 있는가 확인하는 용도로 
	 * toStirng을 사용할 수 있다. 
	 */
	@Override

...
public class StudentVO {
	 ...
	 * 외부에서 필드에 직접 접근(익기, 쓰기)를 못하도록 막는 것
	 * 
	 * [캡슐화]
	 * 클래스 내부에서 어떤일이 일어나는지 외부에서는 몰라도 된다.
	 * 
	 * get() set() 을 만들어서 외부에서 간접적으로 접근할 수 있는 통로를 설정
	 * 단순히 접근 통로 뿐만 아니라
	 ...
	 * 
	 * 정보은닉과 캡슐화를 하고 나면
	 * 만약 많은 데이터를 VO를 통해서 처리를 하려면 (ex) 어떤 값을 VO에 담아서 리스트에 추가하는 일)
	 * 객체를 생성하고, getter()를 이용해서 필드변수에 값을 입력하는 일을 수행한다.
	 * 이 방식이 상당히 번거롭게 작용하는 경우가 있다.
	 * 
	 * getter()를 이용할 때 불편함을 보완하기 위해서

 ...
 * 클래스는 첫글자를 "대문자"로 시작하는 이름을 가져야 합니다.
 * 중간에 숫자,_ 를 포함할 수 있습니다.
 * 빈칸이나 기타 특수문자는 포함할 수 없습니다.
 * 
 * 나는 3개의 method를 가지고 있습니다.
 * method의 첫글자는 "소문자"로 시작하는 이름을 가져야 합니다.
 * 변수명을 짓는 규칙과 같습니다.
 * 
 * 나는 더 많은 method를 가질 수 있으며 
 * 더욱 다양한 명령들을 한데 묶어 포함할 수 있습니다.
 * 내가 포함한 method는 static이 없으므로
 * 내가 가지고 있는 method를 실행하려면
 * 반드시 객체로 먼저 선언, 생성해야합니다.
 */
...
public class Class_01 {
	...
	public void method_02() {
		...
		System.out.println("Class 01의 두번째 method 입니다.");
	}

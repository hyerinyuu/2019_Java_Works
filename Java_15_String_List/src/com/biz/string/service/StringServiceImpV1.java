...
public class StringServiceImpV1 implements StringService {
	...
	/*
	 * 매개변수가 없는 생성자 == super 생성자 / 기본 생성자
	 * 
	 * 1. 필드(멤버변수)중에 객체들을 사용할 수 있도록 초기화, 생성코드를 작성하는 영역
	 * 		===> ***생성자를 안만들면 Null Points Exception이 나옴***(선언만 하고 초기화를 안해서) 
	 */
	...
	public void input() {
		// (일반적인 배열)
		// 1. 생성할 배열 크기를 먼저 지정한 후, 각 요소에 값을 할당하는 방법
		String[] strStudent = new String[5];
		strStudent[0] = "홍길동:서울특별시:010-111:33";
		strStudent[1] = "성춘향:남원시:010-222:16";
		strStudent[2] = "이몽룡:이몽룡:익산시:010-333:18";
		
		// 1. 배열에 할당할 요소가 미리 정해진 경우 
		// 배열의 크기를 설정하지 않고
		// 요소를 나열하여 배열의 크기를 자동설정한 후 요소를 할당하는 방법
